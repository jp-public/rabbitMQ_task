...
class ShoppingWorker:
    ...
    def initialize_rabbitmq(self):
        ...
        self.channel.queue_bind(self.queue, "shopping_events_exchange", self.weight)
    ...
    def handle_shopping_event(self, ch, method, properties, body):
        ...
        shopping_event_json = body
        shopping_event_dict = json.loads(shopping_event_json)
        shopping_event = ProductEvent(shopping_event_dict.get("event_type"),
                                      shopping_event_dict.get("product_number"),
                                      shopping_event_dict.get("timestamp"))
        ...
        if customer_id is None:
            ...
            if shopping_event.event_type == "pick up":
                ...
                pick_up_timestamp = self.shopping_state.pop(shopping_event.product_number)
